...
import { createStationSchema, searchStationSchema, toggleStationSchema, updateStationSchema } from '../validations/station.validation';
...
router.put('/:id', validate(updateStationSchema), updateStation);
